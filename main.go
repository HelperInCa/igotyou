...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	ctx := context.Background() //to read local 'key' generated by gcloud SDK for GCS auth
...
// Perform filtering based on keywords such as web spam etc.(keyword  to be added)
